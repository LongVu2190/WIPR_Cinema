...
namespace Cinema.BS_Layer
{
    internal class BL_Admin
    {
        ...
        {
            string sql = $"EXEC Sp_UpdateShowTime '{ShowTimeID}', '{MovieID}', '{Date}', '{Start}', '{RoomID}'";
            db.MyExecuteNonQuery(sql);
        }
        ...
        {
            string sql = $"EXEC Sp_UpdateMovie '{ID}', N'{Name}', '{Cost}', '{Time}', N'{Actor}', N'{Direc}', '{ComID}'";
            db.MyExecuteNonQuery(sql);
        }
        ...
        {
            string sql = $"EXEC Sp_UpdateCompany '{Company_ID}', N'{Name}', '{Email}', '{Phone}', '{Address}'";
            db.MyExecuteNonQuery(sql);
        }
        ...
        {
            string sql = $"EXEC Sp_UpdateRoom '{Room_ID}', {MaxSeats}, '{Screen_Resolution}', '{Audio_Quality}'";
            db.MyExecuteNonQuery(sql);
        }
