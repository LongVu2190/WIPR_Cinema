...
namespace Cinema
{
    public partial class FormAdmin : Form
    {
        ...
        public User_Object admin;
        public User_Object cus;
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            ...
            else if (ShowTime)
            {
                try
                {
                    bs.AddShowTime(this.DataView.Rows[a].Cells[0].Value.ToString(), this.DataView.Rows[a].Cells[1].Value.ToString(), DateTime.Parse(this.DataView.Rows[a].Cells[2].Value.ToString()), TimeSpan.Parse(this.DataView.Rows[a].Cells[3].Value.ToString()), this.DataView.Rows[a].Cells[8].Value.ToString());
            ...
            else if (Movie)
            {
                try
                {
                    bs.AddMovie(this.DataView.Rows[a].Cells[0].Value.ToString(), this.DataView.Rows[a].Cells[1].Value.ToString(), Int32.Parse(this.DataView.Rows[a].Cells[2].Value.ToString()), TimeSpan.Parse(this.DataView.Rows[a].Cells[3].Value.ToString()), this.DataView.Rows[a].Cells[4].Value.ToString(), this.DataView.Rows[a].Cells[5].Value.ToString(), this.DataView.Rows[a].Cells[6].Value.ToString());
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            if (ShowTime)
            {
                try
                {
                    bs.UpdateShowTime(this.DataView.Rows[row].Cells[0].Value.ToString(), this.DataView.Rows[row].Cells[1].Value.ToString(), DateTime.Parse(this.DataView.Rows[row].Cells[2].Value.ToString()), TimeSpan.Parse(this.DataView.Rows[row].Cells[3].Value.ToString()), this.DataView.Rows[row].Cells[8].Value.ToString());
                    showingTimeToolStripMenuItem_Click(sender, e);
                    MessageBox.Show("SUCCESS!!");
                }
                catch (Exception ex)
            ...
            else if (Movie)
            {
                try
                {
                    bs.UpdateMovie(this.DataView.Rows[row].Cells[0].Value.ToString(), this.DataView.Rows[row].Cells[1].Value.ToString(), Int32.Parse(this.DataView.Rows[row].Cells[2].Value.ToString()), TimeSpan.Parse(this.DataView.Rows[row].Cells[3].Value.ToString()), this.DataView.Rows[row].Cells[4].Value.ToString(), this.DataView.Rows[row].Cells[5].Value.ToString(), this.DataView.Rows[row].Cells[6].Value.ToString());
                    moviesToolStripMenuItem_Click(sender, e);
                    MessageBox.Show("SUCCESS!!");
                }
                catch (Exception ex)
