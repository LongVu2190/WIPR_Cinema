...
namespace Cinema.BS_Layer
{
    internal class BL_Login
    {
        ...
        public User_Object AdminLogin(string User_ID, string Password)
        {
            ...
            var adminLogin = from adLogin in cinemaEntity.Fn_AdminLogin(User_ID, Password)
                             select adLogin;
        ...
        public User_Object CustomerLogin(string User_ID, string Password)
        {
            ...
            var customerLogin = from cusLogin in cinemaEntity.Fn_CustomerLogin(User_ID, Password)
                                select cusLogin;
        ...
        {
            cinemaEntity = new CinemaEntities();
            cinemaEntity.Sp_AddNewCustomer(User_ID, Password, Name, Email, Address, Phone);
        }
    }
}
