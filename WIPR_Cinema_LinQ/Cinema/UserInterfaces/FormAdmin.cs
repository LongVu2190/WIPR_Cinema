    ...
    public partial class FormAdmin : Form
    {
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            ...
            else if (Company)
            {
                try
                {
                    bs.AddCompany(this.DataView.Rows[a].Cells[0].Value.ToString(), this.DataView.Rows[a].Cells[1].Value.ToString(), this.DataView.Rows[a].Cells[2].Value.ToString(), this.DataView.Rows[a].Cells[3].Value.ToString(), this.DataView.Rows[a].Cells[4].Value.ToString());
            ...
            else if (Room)
            {
                try
                {
                    bs.AddRoom(this.DataView.Rows[a].Cells[0].Value.ToString(), Int32.Parse(this.DataView.Rows[a].Cells[1].Value.ToString()), this.DataView.Rows[a].Cells[2].Value.ToString(), this.DataView.Rows[a].Cells[3].Value.ToString());
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            else if (Company)
            {
                try
                {
                    bs.UpdateCompany(this.DataView.Rows[row].Cells[0].Value.ToString(), this.DataView.Rows[row].Cells[1].Value.ToString(), this.DataView.Rows[row].Cells[2].Value.ToString(), this.DataView.Rows[row].Cells[3].Value.ToString(), this.DataView.Rows[row].Cells[4].Value.ToString());
                    companyToolStripMenuItem_Click(sender, e);
                    MessageBox.Show("SUCCESS!!");
                }
                catch (Exception ex)
            ...
            {
                int seats = Int32.Parse(this.DataView.Rows[row].Cells[1].Value.ToString());
                try
                {
                    bs.UpdateRoom(this.DataView.Rows[row].Cells[0].Value.ToString(), seats, this.DataView.Rows[row].Cells[2].Value.ToString(), this.DataView.Rows[row].Cells[3].Value.ToString());
                    roomToolStripMenuItem_Click(sender, e);
                    MessageBox.Show("SUCCESS!!");
                }
                catch (Exception ex)
